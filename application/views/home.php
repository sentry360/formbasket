<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
    <div class="row">
        <div class="col-4" style="min-width: 256px;">
            <img src="/assets/img/icons/logo_256.png" />
        </div>
        <div class="col-6">
        ...
        <aside class="col-md-4 blog-sidebar">
            ...
            <div class="p-3">
                ...
                <ol class="list-unstyled">
                    ...
                    <li><a href="https://getbootstrap.com/docs/4.2/examples/checkout/">Bootstrap Checkout form</a></li>
                </ol>
            </div>
        </aside><!-- /.blog-sidebar -->
    </div><!-- /.row -->
